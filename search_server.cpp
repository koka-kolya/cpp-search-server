...
void SearchServer::AddDocument(
        int document_id, std::string_view document,
...
std::tuple<std::vector<std::string_view>, DocumentStatus> SearchServer::MatchDocument(
	...
	bool is_minus_consist = std::any_of(
...
SearchServer::Query SearchServer::ParseQuery(std::string_view text, bool is_need_sort) const {
    Query result;
